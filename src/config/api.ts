...
// Production must receive the public HTTPS backend URL through VITE_API_URL.
// Falling back to the frontend host:5000 makes deployed requests target Vercel,
// where the Express server and SQLite database do not exist.
export const API_URL = envApiUrl || (isDev ? '' : '');
